...
func GetKeyHubProvider(store esv1.GenericStore) (*esv1.KeyHubProvider, error) {
	if store == nil {
...
func GetKeyHubAuth(ctx context.Context, auth esv1.KeyHubAuth, kube kubeClient.Client, storeKind, namespace string) (string, string, error) {
