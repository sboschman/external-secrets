...
func (c *client) newVaultRecordFilter(ref esv1beta1.ExternalSecretFind) khClient.VaultRecordFilter {
...
func (c *client) filterSecretsByName(secrets []keyhubmodels.VaultVaultRecordable, name esv1beta1.FindName) ([]keyhubmodels.VaultVaultRecordable, error) {
