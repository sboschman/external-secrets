...
import (
	...
	"github.com/external-secrets/external-secrets/providers/v1/keyhub/util"
...
func (p *Provider) newClient(ctx context.Context, store esv1.GenericStore, cfg *esv1.KeyHubProvider, kube kubeClient.Client, namespace string) (esv1.SecretsClient, error) {
	key := cache.Key{
...
// NewProvider creates a new KeyHub Provider instance.
